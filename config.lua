...
Config.PauseMapText = 'Serenity Roleplay'                    -- Text shown above the map when ESC is pressed. If left empty 'FiveM' will appear
...
Config.Discord = {
    ...
    applicationId = '1320649283648880680',                 -- The discord application id
    iconLarge = 'discord_bot',                             -- The name of the large icon
    iconLargeHoverText = 'Five M Server Logo',             -- The hover text of the large icon
    iconSmall = 'small_logo_name',                         -- The name of the small icon
    iconSmallHoverText = 'This is a Small icon with text', -- The hover text of the small icon
    updateRate = 50000,                                    -- How often the player count should be updated
    showPlayerCount = true,                                -- If set to true the player count will be displayed in the rich presence
    maxPlayers = 10,                                       -- Maximum amount of players
    buttons = {
        {
            text = 'Discord',
            url = 'https://discord.gg/Cmakb5udQg'
        },
        {
            text = 'Server Connect',
            url = 'https://cfx.re/join/av7v49'
        }
    }
}
